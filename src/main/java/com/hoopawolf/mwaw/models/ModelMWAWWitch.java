...
public class ModelMWAWWitch extends ModelVillager {
    ...
    public ModelMWAWWitch(float p_i1166_1_) {
        ...
        this.witchHat.setTextureOffset(0, 64).addBox(0.0F, -0.5F, 0.0F, 10, 2, 10);
