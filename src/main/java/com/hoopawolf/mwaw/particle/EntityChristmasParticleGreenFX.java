...
public class EntityChristmasParticleGreenFX extends EntityFX {

    public EntityChristmasParticleGreenFX(World par1World, double par2, double par4, double par6, double par9, double par10, double par11) {
        super(par1World, par2, par4, par6, par9, par10, par11);

        this.particleTextureIndexX = 7;
        this.particleTextureIndexY = 0;
        particleAlpha = 0.5F;
        particleGreen = 100.0F;
