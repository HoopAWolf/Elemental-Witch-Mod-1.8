...
public class EntityDarkCircleSmallFX extends EntityDarkFX {
    ...
    public EntityDarkCircleSmallFX(World world, double x, double y, double z, double motionY, double angle) {
        ...
        particleScale = portalParticleScale = 5.6f;
    }
