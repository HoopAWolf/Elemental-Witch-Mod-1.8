...
public class EntityLightningCircleFX extends EntityLightningFX {
    ...
    public EntityLightningCircleFX(World world, double x, double y, double z, double motionY, double angle) {
