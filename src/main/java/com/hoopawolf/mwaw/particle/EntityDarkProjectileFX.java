...
public class EntityDarkProjectileFX extends EntityFX {

    public EntityDarkProjectileFX(World par1World, double par2, double par4, double par6, double par9, double par10, double par11) {
