...
public class RenderTornado extends RenderLiving {
    private static final ResourceLocation Tornado_Texture = new ResourceLocation(Reference.MOD_ID + ":" + "textures/entity/lightninggolem.png");

    public RenderTornado(final ModelBase par1ModelBase, final float par2) {
