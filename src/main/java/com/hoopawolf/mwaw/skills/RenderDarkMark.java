...
public class RenderDarkMark extends RenderLiving {
    private static final ResourceLocation DarkMark_Texture = new ResourceLocation(Reference.MOD_ID + ":" + "textures/entity/DarkMark.png");

    public RenderDarkMark(RenderManager p_i46149_1_, final ModelBase par1ModelBase, final float par2) {
