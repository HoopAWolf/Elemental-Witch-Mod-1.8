...
public class RenderFireBat extends RenderLiving {
    private static final ResourceLocation FireBat_Texture = new ResourceLocation(Reference.MOD_ID + ":" + "textures/entity/firebat.png");

    public RenderFireBat(final ModelBase par1ModelBase, final float par2) {
