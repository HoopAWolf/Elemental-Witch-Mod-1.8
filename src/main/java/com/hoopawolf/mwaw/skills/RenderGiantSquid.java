...
public class RenderGiantSquid extends RenderLiving {
    private static final ResourceLocation squidTextures = new ResourceLocation(Reference.MOD_ID + ":" + "textures/entity/squid.png");
    private float scale;

    public RenderGiantSquid(ModelBase p_i1268_1_, float p_i1268_2_, float p_i1255_3_) {
        super(p_i1268_1_, p_i1268_2_ * p_i1255_3_);
        this.scale = p_i1255_3_;
    }

    protected void preRenderCallback(EntityGiantSquid p_77041_1_, float p_77041_2_) {
     ...
     */
    public void doRender(EntityGiantSquid p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityGiantSquid p_110775_1_) {
        return squidTextures;
    }

    protected void rotateCorpse(EntityGiantSquid p_77043_1_, float p_77043_2_, float p_77043_3_, float p_77043_4_) {
     ...
     */
    protected float handleRotationFloat(EntityGiantSquid p_77044_1_, float p_77044_2_) {
