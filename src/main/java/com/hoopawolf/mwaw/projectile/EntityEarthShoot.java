...
public class EntityEarthShoot extends EntityMWAWProjectileHandler {

    public EntityEarthShoot(final World par1World) {
        super(par1World);
    ...
    public EntityEarthShoot(final World par1World, final double par2,
    ...
    public void onUpdate() {
        ...
        if (worldObj.isRemote)
            this.worldObj.spawnParticle(EnumParticleTypes.BLOCK_DUST, this.posX, this.posY + 0.5D, this.posZ, 0.0D, 0.0D, 0.0D);
