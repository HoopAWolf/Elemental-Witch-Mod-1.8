...
public class EntityChristmasShoot extends EntityMWAWProjectileHandler {

    public EntityChristmasShoot(final World par1World) {
        super(par1World);
    ...
    public EntityChristmasShoot(final World par1World, final double par2,
    ...
    public void onUpdate() {
        ...
        if (worldObj.isRemote)
            MoWitchAndWizard.proxy.spawnParticles("christmas_shoot", this);
