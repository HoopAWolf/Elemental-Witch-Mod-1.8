...
public class EntityMWAWCheckPumpkin extends EntityMWAWProjectileHandler {
    public EntityMWAWCheckPumpkin(final World par1World) {
        super(par1World);
    ...
    public EntityMWAWCheckPumpkin(final World par1World, final double par2,
