...
public abstract class EntityMWAWProjectileHandler extends Entity {
    ...
    public EntityMWAWProjectileHandler(World worldIn) {
        super(worldIn);
        this.setSize(1.0F, 1.0F);
    }

    public EntityMWAWProjectileHandler(World worldIn, double x, double y, double z, double accelX, double accelY, double accelZ) {
        super(worldIn);
        this.setSize(1.0F, 1.0F);
    ...
    public EntityMWAWProjectileHandler(World worldIn, EntityLivingBase shooter, double accelX, double accelY, double accelZ) {
        super(worldIn);
