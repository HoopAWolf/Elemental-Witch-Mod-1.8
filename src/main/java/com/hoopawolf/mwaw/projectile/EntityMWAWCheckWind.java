...
public class EntityMWAWCheckWind extends EntityMWAWProjectileHandler {
    public EntityMWAWCheckWind(final World par1World) {
        super(par1World);
    ...
    public EntityMWAWCheckWind(final World par1World, final double par2,
        ...
        if (!this.worldObj.isRemote) {
            if (par1MovingObjectPosition.entityHit != null) {
                if (this.shootingEntity != null) {
                    ...
                    entitywitherskull1.setLocationAndAngles(par1MovingObjectPosition.entityHit.posX, par1MovingObjectPosition.entityHit.posY, par1MovingObjectPosition.entityHit.posZ, this.rotationYaw, 0);
                    MWAWEntityUtil.spawnInWorld(worldObj, entitywitherskull1);

                    entitywitherskull1.mountEntity(par1MovingObjectPosition.entityHit);
