...
public class RenderWindShoot extends Render {
    private float field_77002_a;

    public RenderWindShoot(RenderManager p_i46176_1_, float par1) {
        super(p_i46176_1_);
        this.field_77002_a = par1;
    }

    public void doRenderFireball(EntityWindShoot par1EntityFireball, double par2, double par4, double par6, float par8, float par9) {
    ...
    protected ResourceLocation getFireballTextures(EntityWindShoot par1EntityFireball) {
    ...
    protected ResourceLocation getEntityTexture(Entity par1Entity) {
        return this.getFireballTextures((EntityWindShoot) par1Entity);
    }
    ...
    public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9) {
        this.doRenderFireball((EntityWindShoot) par1Entity, par2, par4, par6, par8, par9);
    }
}
