...
public class EntityLightShoot extends EntityMWAWProjectileHandler {

    public EntityLightShoot(final World par1World) {
        super(par1World);
    ...
    public EntityLightShoot(final World par1World, final double par2,
    ...
    public void onUpdate() {
        ...
        if (worldObj.isRemote)
            MoWitchAndWizard.proxy.spawnParticles("light_shoot", this);
