...
public class EntityMWAWCheckDark extends EntityMWAWProjectileHandler {
    public EntityMWAWCheckDark(final World par1World) {
        super(par1World);
    ...
    public EntityMWAWCheckDark(final World par1World, final double par2,
        ...
        if (!this.worldObj.isRemote) {
            if (par1MovingObjectPosition.entityHit != null) {
                if (this.shootingEntity != null) {
                    ...
                    final EntityEnderHole entitywitherskull1 = new EntityEnderHole(worldObj);
                    entitywitherskull1.setLocationAndAngles(par1MovingObjectPosition.entityHit.posX, par1MovingObjectPosition.entityHit.posY + 2, par1MovingObjectPosition.entityHit.posZ, this.rotationYaw, 0);
