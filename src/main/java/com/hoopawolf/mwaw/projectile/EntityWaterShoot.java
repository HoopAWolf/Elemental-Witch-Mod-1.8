...
public class EntityWaterShoot extends EntityMWAWProjectileHandler {

    public EntityWaterShoot(final World par1World) {
        super(par1World);
    ...
    public EntityWaterShoot(final World par1World, final double par2,
        ...
        if (!this.worldObj.isRemote) {
            if (par1MovingObjectPosition.entityHit != null) {
                ...
                if (par1MovingObjectPosition.entityHit instanceof EntityLivingBase) {
                    ((EntityLivingBase) par1MovingObjectPosition.entityHit).addPotionEffect(new PotionEffect(
    ...
    public void onUpdate() {
        ...
        if (worldObj.isRemote) {
            this.worldObj.spawnParticle(EnumParticleTypes.WATER_SPLASH, this.posX, this.posY + 0.5D, this.posZ, 0.0D, 0.0D, 0.0D);
        }
        super.onUpdate();
    }
