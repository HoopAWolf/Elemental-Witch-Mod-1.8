...
public class EntityMWAWCheckWater extends EntityMWAWProjectileHandler {
    public EntityMWAWCheckWater(final World par1World) {
        super(par1World);
    ...
    public EntityMWAWCheckWater(final World par1World, final double par2,
