...
public class LayerEarthPetDeath implements LayerRenderer {

    public void func_177213_a(EntityEarthPet3 p_177213_1_, float p_177213_2_, float p_177213_3_, float p_177213_4_, float p_177213_5_, float p_177213_6_, float p_177213_7_, float p_177213_8_) {
        if (p_177213_1_.deathTicks > 0) {
            ...
            for (int i = 0; (float) i < (f7 + f7 * f7) / 2.0F * 60.0F; ++i) {
                ...
                worldrenderer.setColorRGBA(139, 69, 19, (int) (255.0F * (1.0F - f8)));
                worldrenderer.addVertex(0.0D, 0.0D, 0.0D);
                worldrenderer.setColorRGBA(139, 69, 19, 0);
    ...
    public void doRenderLayer(EntityLivingBase p_177141_1_, float p_177141_2_, float p_177141_3_, float p_177141_4_, float p_177141_5_, float p_177141_6_, float p_177141_7_, float p_177141_8_) {
        this.func_177213_a((EntityEarthPet3) p_177141_1_, p_177141_2_, p_177141_3_, p_177141_4_, p_177141_5_, p_177141_6_, p_177141_7_, p_177141_8_);
    }
}
