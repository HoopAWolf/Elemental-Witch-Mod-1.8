...
public class EntityEarthPet2 extends EntityTameable {

    public int deathTicks;
    int skillTimer = 300;
    int involveTimer = 0;

    public EntityEarthPet2(World par1World) {
        super(par1World);
        setSize(1.6F, 2.6F);
    ...
    public boolean func_142018_a(EntityLivingBase p_142018_1_, EntityLivingBase p_142018_2_) {
        if (!(p_142018_1_ instanceof EntityGhast)) {
            if (p_142018_1_ instanceof EntityEarthPet2) {
                EntityEarthPet2 entitywolf = (EntityEarthPet2) p_142018_1_;
        ...
        if (!p_70085_1_.isSneaking()) {
            if (p_70085_1_.getHeldItem() != null && p_70085_1_.getHeldItem().getItem() == MWAWItemRegistry.earthshard) {
                ...
                if (involveTimer != 10) {
                    ...
                    final EntityEarthPet3 mob = new EntityEarthPet3(worldObj);
    ...
    public void writeToNBT(NBTTagCompound compund) {
        ...
        compund.setInteger("PetInvolveTimerEarth", involveTimer);
    ...
    public void readFromNBT(NBTTagCompound compund) {
        ...
        involveTimer = compund.getInteger("PetInvolveTimerEarth");
