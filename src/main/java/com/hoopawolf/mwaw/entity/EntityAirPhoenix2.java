...
public class EntityAirPhoenix2 extends EntityTameable {

    public int deathTicks;
    int tornadoTimer = 300;
    int involveTimer = 0;

    public EntityAirPhoenix2(World par1World) {
        super(par1World);
        setSize(1.7F, 2.9F);
    ...
    public boolean func_142018_a(EntityLivingBase p_142018_1_, EntityLivingBase p_142018_2_) {
        if (!(p_142018_1_ instanceof EntityCreeper) && !(p_142018_1_ instanceof EntityGhast)) {
            if (p_142018_1_ instanceof EntityAirPhoenix2) {
                EntityAirPhoenix2 entitywolf = (EntityAirPhoenix2) p_142018_1_;
        ...
        if (!p_70085_1_.isSneaking()) {
            ...
            if (p_70085_1_.getHeldItem() != null && p_70085_1_.getHeldItem().getItem() == MWAWItemRegistry.airshard) {
                ...
                if (involveTimer != 10) {
                    ...
                    final EntityAirPhoenix3 mob = new EntityAirPhoenix3(worldObj);
