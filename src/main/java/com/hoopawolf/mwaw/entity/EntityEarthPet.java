...
public class EntityEarthPet extends EntityTameable {

    public int deathTicks;
    int involveTimer = 0;

    public EntityEarthPet(World par1World) {
        super(par1World);
        setSize(0.7F, 0.9F);
    ...
    public boolean func_142018_a(EntityLivingBase p_142018_1_, EntityLivingBase p_142018_2_) {
        if (!(p_142018_1_ instanceof EntityCreeper) && !(p_142018_1_ instanceof EntityGhast)) {
            if (p_142018_1_ instanceof EntityEarthPet) {
                EntityEarthPet entitywolf = (EntityEarthPet) p_142018_1_;
        ...
        if (!p_70085_1_.isSneaking()) {
            ...
            if (p_70085_1_.getHeldItem() != null && p_70085_1_.getHeldItem().getItem() == MWAWItemRegistry.earthshard) {
                ...
                if (involveTimer != 5) {
                    ...
                    final EntityEarthPet2 mob = new EntityEarthPet2(worldObj);
