...
public class EntityDarkPet extends EntityTameable {
    ...
    public EntityDarkPet(World par1World) {
        super(par1World);
        setSize(0.7F, 0.9F);
    ...
    public EntityDarkPet createChild(EntityAgeable p_90011_1_) {
        return null;
    }

    public boolean func_142018_a(EntityLivingBase p_142018_1_, EntityLivingBase p_142018_2_) {
        if (!(p_142018_1_ instanceof EntityCreeper) && !(p_142018_1_ instanceof EntityGhast)) {
            if (p_142018_1_ instanceof EntityDarkPet) {
                EntityDarkPet entitywolf = (EntityDarkPet) p_142018_1_;
        ...
        if (!p_70085_1_.isSneaking()) {
            ...
            if (p_70085_1_.getHeldItem() != null && p_70085_1_.getHeldItem().getItem() == MWAWItemRegistry.darkshard) {
                ...
                if (involveTimer != 5) {
                    ...
                    final EntityDarkPet2 mob = new EntityDarkPet2(worldObj);
    ...
    public float getFloatingRotation() {
        return 15 - Math.abs((float) Math.sin(floatingRotation) * 5.5F);
    }
