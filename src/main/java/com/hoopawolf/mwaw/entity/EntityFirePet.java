...
public class EntityFirePet extends EntityTameable {

    public int deathTicks;
    int involveTimer = 0;

    public EntityFirePet(World par1World) {
        super(par1World);
        setSize(1.0F, 0.9F);
    ...
    protected void onDeathUpdate() {
        ...
        if (this.deathTicks >= 0 && this.deathTicks <= 140) {
            if (worldObj.isRemote) {
                MoWitchAndWizard.proxy.spawnParticles("fire_tornado", this);
                MoWitchAndWizard.proxy.spawnParticles("fire_tornado", this);
            }
        }
    ...
    public boolean func_142018_a(EntityLivingBase p_142018_1_, EntityLivingBase p_142018_2_) {
        if (!(p_142018_1_ instanceof EntityCreeper) && !(p_142018_1_ instanceof EntityGhast)) {
            if (p_142018_1_ instanceof EntityFirePet) {
                EntityFirePet entitywolf = (EntityFirePet) p_142018_1_;
        ...
        if (!p_70085_1_.isSneaking()) {
            ...
            if (p_70085_1_.getHeldItem() != null && p_70085_1_.getHeldItem().getItem() == MWAWItemRegistry.fireshard) {
                ...
                if (involveTimer != 5) {
                    ...
                    final EntityFirePet2 mob = new EntityFirePet2(worldObj);
