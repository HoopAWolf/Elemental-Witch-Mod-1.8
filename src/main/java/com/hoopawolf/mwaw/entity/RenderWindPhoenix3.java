...
public class RenderWindPhoenix3 extends RenderLiving {
    private static final ResourceLocation WindPhoenix3_Texture = new ResourceLocation(Reference.MOD_ID + ":" + "textures/entity/windpet3.png");

    public RenderWindPhoenix3(final ModelBase par1ModelBase, final float par2) {
    ...
    protected int shouldRenderPass(EntityAirPhoenix3 p_77032_1_, int p_77032_2_, float p_77032_3_) {
        if (p_77032_2_ == 0) {
            this.bindTexture(WindPhoenix3_Texture);
    ...
    protected void renderEquippedItems(EntityAirPhoenix3 p_77029_1_, float p_77029_2_) {
    ...
    protected int getColorMultiplier(EntityAirPhoenix3 p_77030_1_, float p_77030_2_, float p_77030_3_) {
