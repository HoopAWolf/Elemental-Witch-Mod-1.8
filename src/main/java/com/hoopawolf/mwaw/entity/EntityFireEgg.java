...
public class EntityFireEgg extends EntityTameable {

    public int TimerToHatch = 1000;

    public EntityFireEgg(World p_i1744_1_) {
        super(p_i1744_1_);
        setSize(0.7F, 0.9F);
    ...
    public void onLivingUpdate() {
        ...
        if (TimerToHatch == 0) {
            ...
            final EntityFirePet mob = new EntityFirePet(worldObj);
    ...
    public EntityFireEgg createChild(EntityAgeable p_90011_1_) {
        return null;
    }
