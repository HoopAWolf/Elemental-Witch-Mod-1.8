...
public class RenderSandWitch extends RenderLiving {
    private static final ResourceLocation SandWitch_Texture = new ResourceLocation(Reference.MOD_ID + ":" + "textures/entity/sandwitch.png");

    public RenderSandWitch(RenderManager p_i46149_1_, final ModelBase par1ModelBase, final float par2) {
