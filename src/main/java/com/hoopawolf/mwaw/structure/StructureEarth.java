...
public class StructureEarth extends MWAWSymmetricalStructure {
    ...
    private static StructureEarth _instance = null;

    public StructureEarth() {
        super(6, 6);
    }
     ...
     */
    public static StructureEarth getInstance() {
        if (_instance == null)
            _instance = new StructureEarth();
    ...
    protected void generateLayers() {
        ...
        BlockWrapper w = new BlockWrapper(Blocks.cobblestone);
        BlockWrapper wp = new BlockWrapper(Blocks.dirt);
        BlockWrapper If = new BlockWrapper(Blocks.iron_bars);
        BlockWrapper f = new BlockWrapper(Blocks.cobblestone_wall);
        BlockWrapper c = new BlockWrapper(Blocks.cobblestone);
        BlockWrapper bg = new BlockWrapper(Blocks.dirt);
        BlockWrapper ws = new BlockWrapper(Blocks.wooden_slab);
        BlockWrapper g = new BlockWrapper(Blocks.mossy_cobblestone);
        BlockWrapper wa = new BlockWrapper(Blocks.air);
        BlockWrapper O = new BlockWrapper(Blocks.air);

        BlockWrapper ta = new BlockWrapper(MWAWBlockRegistry.earthwitchspawner);
        ...
        addLayer(3, new BlockWrapper[]{O, f, f, f, f, w, O, O, O, O, O, f, O,
                ws, w, O, O, f, O, ws, ws, w, O, f, g, wp, ws, ws, O, f, wa, g,
                O, O, O, O});
        ...
        addLayer(6, new BlockWrapper[]{O, O, O, O, wp, w, O, O, O, wp, wp,
                wp, wp, wp, w, wp, wp, O, wa, wp, wp, w, O, O, wp, wp, wp, wp,
                O, O, w, wp, wa, wp, O, O});

        addLayer(7, new BlockWrapper[]{O, O, O, O, f, w, O, O, O, O, O, O, O,
                O, O, w, O, O, O, O, O, O, O, O, O, O, O, f, O, O, ta, O, O, O,
                O, O});
